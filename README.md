...
## 2026/04/21 - 1.3.1.4
- 다운후 인코딩에 실시간에서만 필요한 코드제거, 안정성 향상
- 유료 다운관련 문제수정

## 2026/03/26 - 1.3.1.3
- 검색 유연화(기존도메인 검색시 자동변환)
- 해외 사용자 대응추가
...
- 멀티다운로드 다운로드 방식 변경
- 다시보기 후처리 안정성 강화
- 대부분의 예약 플랫폼에 선호화질 나열가능하도록 변경

## 2026/01/31 - 1.3.0.9
- 1.3.0.8버전 프로그램 안정성 문제수정

## 2026/01/31 - 1.3.0.8
- 구플 라이브 안정성강화
- 해외IP에서 해외우회 기능 충돌 문제수정

## 2026/01/26 - 1.3.0.7
- 구독 플러스 VOD 문제 수정

## 2026/01/25 - 1.3.0.6
- 구독 플러스 문제 수정 (아직 테스트되지 않음)
- 외부모듈 임시버전 사용법 추가

## 2026/01/14 - 1.3.0.5
- 검색에 일부 방송 정보가 제대로 표시되지 않는문제수정
- 안내메시지 때문에 비번입력이 어려운 문제수정
...
## 2025/10/28 - 1.3.0.2
- 숲 결합+삭제 오류수정(확장자ts 사용시 발생)
- 트위치 검색 다운로드 문제수정

## 2025/10/22 - 1.3.0.1
- 숲 구독 플러스 임시지원
- 숲 다운시 진행률 UI개선
- 숲 저화질 문제 개선 (VPN or 해외서버 프록시)
- 유튜브 예약감지 수정
- 간단 영상편집툴에 싱크조절 추가
- 일부 경우에만 발생할 수 있는 문제수정
  - 외부모듈 업데이트 문제수정
  - 버전처리 관련 문제수정

## 2025/05/12 - 1.3.0.0
- 치지직 관련기능 검색차단 및 제공중단
- [UI] 이용기한 일주일전 색상 변경

## 2025/03/31 - 1.2.9.9
- [유튜브 예약] 멤버십 라이브 감지 강화
- 치지직
  - VOD 영상 길이가 맞지않아 발생한 완료, 변환 문제 수정
  - 타임머신 기능 비활성화
  - [핫픽스] 라이브 정보 주소 변경반영
- 엣지 실패 보완 기능: 거의 사용되지 않아 제거
- [UI] 다크모드 임시지원
- [핫픽스] 충전실패 잠금시 내역이 늦게도착한 경우 자동해제

## 2025/03/10 - 1.2.9.8
- [유튜브] Edge를 이용한 자동 cookies.txt 생성가능
- [UI 문제수정] 안내 메시지, 프로그램 사라지는 문제
